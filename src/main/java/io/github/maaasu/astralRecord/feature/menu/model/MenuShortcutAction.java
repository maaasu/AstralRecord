...
public enum MenuShortcutAction {
    /** 未設定スロット。 */
    NONE("NONE", "未設定", Material.GRAY_DYE, NamedTextColor.GRAY, null),
    /** メインメニューを開く。 */
    MAIN_MENU("MAIN_MENU", "メニュー", Material.NETHER_STAR, NamedTextColor.AQUA, null),
    /** ノーマルインベントリを表示する。 */
    INVENTORY_NORMAL("INVENTORY_NORMAL", InventoryType.NORMAL.getDisplayNameJa(), Material.CHEST, NamedTextColor.YELLOW, InventoryType.NORMAL),
    /** 通貨インベントリを表示する。 */
    INVENTORY_CURRENCY("INVENTORY_CURRENCY", InventoryType.CURRENCY.getDisplayNameJa(), Material.EMERALD, NamedTextColor.GREEN, InventoryType.CURRENCY),
    /** 装備インベントリを表示する。 */
    INVENTORY_EQUIPMENT("INVENTORY_EQUIPMENT", InventoryType.EQUIPMENT.getDisplayNameJa(), Material.IRON_CHESTPLATE, NamedTextColor.GOLD, InventoryType.EQUIPMENT),
    /** ルーンインベントリを表示する。 */
    INVENTORY_RUNE("INVENTORY_RUNE", InventoryType.RUNE.getDisplayNameJa(), Material.AMETHYST_SHARD, NamedTextColor.LIGHT_PURPLE, InventoryType.RUNE);
